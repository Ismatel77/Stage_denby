...
entity fft64 is
	port (
		...
		fftpts_in    : in  std_logic_vector(6 downto 0)  := (others => '0'); --       .fftpts_in
...
architecture rtl of fft64 is
	...
	end component fft64_fft_ii_0;

begin

	fft_ii_0 : component fft64_fft_ii_0
		port map (
			clk          => clk,          --    clk.clk

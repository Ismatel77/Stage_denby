...
# ACDS 20.1 720 linux 2021.07.30.19:20:46
...
# ----------------------------------------
# If fft64 is one of several IP cores in your
...
TOP_LEVEL_NAME="fft64"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/ismael/intelFPGA_lite/20.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/fft64_fft_ii_0_opt_twr2.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft64_fft_ii_0_opt_twi1.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft64_fft_ii_0_opt_twr1.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft64_fft_ii_0_opt_twi2.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/apn_fft_mult_can.vhd"                          -work fft_ii_0
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/synopsys/apn_fft_mult_cpx_1825.v"                       -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/apn_fft_mult_cpx.vhd"                          -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/hyper_opt_OFF_pkg.vhd"                         -work fft_ii_0
  ...
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_lib_pkg.vhd"                  -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_bit_reverse_addr_control.vhd"        -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_core.vhd"                     -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_twrom.vhd"                    -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_cma_adder_fp.vhd"             -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_bfi.vhd"                      -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_bit_reverse_reverse_carry_adder.vhd" -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_stg_out_pipe.vhd"             -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_bf_control.vhd"               -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_top.vhd"                      -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_delay.vhd"                    -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_bfii.vhd"                     -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_bit_reverse_core.vhd"                -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_cma_fp.vhd"                   -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_stg_pipe.vhd"                 -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_cma_bfi_fp.vhd"               -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_addsub.vhd"                   -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_adder_fp.vhd"                 -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_enable_control.vhd"           -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_stage.vhd"                    -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_cma.vhd"                      -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/submodules/synopsys/auk_dspip_r22sdf_counter.vhd"                  -work fft_ii_0
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fft64_fft_ii_0.sv"                                      -work fft_ii_0
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/fft64.v"                                                                         
fi

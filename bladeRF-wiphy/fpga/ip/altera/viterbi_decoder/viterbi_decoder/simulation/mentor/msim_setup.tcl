...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "viterbi_decoder"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/src/viterbi_decoder_viterbi_ii_0_ini.hex ./
}
...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/viterbi_decoder_viterbi_ii_0.v"     -work viterbi_ii_0
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/viterbi_decoder.v"                                               
}
